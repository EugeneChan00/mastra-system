...
export const PI_AGENT_PROMPT_TOOL_USAGE_PROMPT = `## Prompt-to-tool binding
...
- A worker answer becomes evidence only after Pi reads it and checks its claims against files, diffs, logs, tests, docs, artifacts, transcripts, or explicit user instruction.
...
export const PI_AGENT_ORCHESTRATION_AND_USAGE_TOOLING_PROMPT = [
