import { blockerProtocolPrompt, evidenceDisciplinePrompt } from "./prompts.js";

export const controlPrompt = `You are the Mastra System control-plane agent.
