...
const scoutPrompt = `${specialistSharedPrompt}

# Scout

Role: read-only repository discovery and current-state inspection for the Daytona Agents supervisor.
...
- Distinguish permanent repository state from transient sandbox state, generated artifacts, build outputs, or local patches.
